...
item_table: dict[str, TunicItemData] = {
    ...
    "Enemy Soul (Administrator)": TunicItemData(IC.progression, 0, 182, "Enemy Souls"),
    "Enemy Soul (Phrend)": TunicItemData(IC.progression, 0, 183, "Enemy Souls"),
    "Enemy Soul (Beefboy)": TunicItemData(IC.progression, 0, 184, "Enemy Souls"),
    "Enemy Soul (Blobs)": TunicItemData(IC.progression, 0, 185, "Enemy Souls"),
    "Enemy Soul (Fleemers)": TunicItemData(IC.progression, 0, 186, "Enemy Souls"),
    "Enemy Soul (Crabs)": TunicItemData(IC.progression, 0, 187, "Enemy Souls"),
    "Enemy Soul (Chompignom)": TunicItemData(IC.progression, 0, 188, "Enemy Souls"),
    "Enemy Soul (Husher)": TunicItemData(IC.progression, 0, 189, "Enemy Souls"),
    "Enemy Soul (Autobolt)": TunicItemData(IC.progression, 0, 190, "Enemy Souls"),
    "Enemy Soul (Zombie Foxes)": TunicItemData(IC.progression, 0, 191, "Enemy Souls"),
    "Enemy Soul (Frogs)": TunicItemData(IC.progression, 0, 192, "Enemy Souls"),
    "Enemy Soul (Lost Echo)": TunicItemData(IC.progression, 0, 193, "Enemy Souls"),
    "Enemy Soul (Gunslinger)": TunicItemData(IC.progression, 0, 194, "Enemy Souls"),
    "Enemy Soul (Hedgehogs)": TunicItemData(IC.progression, 0, 195, "Enemy Souls"),
    "Enemy Soul (Laser Trap)": TunicItemData(IC.progression, 0, 196, "Enemy Souls"),
    "Enemy Soul (Envoy)": TunicItemData(IC.progression, 0, 197, "Enemy Souls"),
    "Enemy Soul (Garden Knight)": TunicItemData(IC.progression, 0, 198, "Enemy Souls"),
    "Enemy Soul (Librarian)": TunicItemData(IC.progression, 0, 199, "Enemy Souls"),
    "Enemy Soul (Plover)": TunicItemData(IC.progression, 0, 200, "Enemy Souls"),
    "Enemy Soul (Fairies)": TunicItemData(IC.progression, 0, 201, "Enemy Souls"),
    "Enemy Soul (Scavengers)": TunicItemData(IC.progression, 0, 202, "Enemy Souls"),
    "Enemy Soul (Boss Scavenger)": TunicItemData(IC.progression, 0, 203, "Enemy Souls"),
    "Enemy Soul (Tentacle)": TunicItemData(IC.progression, 0, 204, "Enemy Souls"),
    "Enemy Soul (Rudelings)": TunicItemData(IC.progression, 0, 205, "Enemy Souls"),
    "Enemy Soul (Spiders)": TunicItemData(IC.progression, 0, 206, "Enemy Souls"),
    "Enemy Soul (Siege Engine)": TunicItemData(IC.progression, 0, 207, "Enemy Souls"),
    "Enemy Soul (Slorm)": TunicItemData(IC.progression, 0, 208, "Enemy Souls"),
