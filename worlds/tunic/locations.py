...
location_table: Dict[str, TunicLocationData] = {
    "Bottom of the Well - [Powered Secret Room] Chest": TunicLocationData("Bottom of the Well", "Bottom of the Well Back"),
    "Bottom of the Well - [Entryway] Chest": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Bottom of the Well - [Third Room] Beneath Platform Chest": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Bottom of the Well - [Third Room] Tentacle Chest": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Bottom of the Well - [Entryway] Obscured Behind Waterfall": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Bottom of the Well - [Save Room] Upper Floor Chest 1": TunicLocationData("Bottom of the Well", "Bottom of the Well Back"),
    "Bottom of the Well - [Save Room] Upper Floor Chest 2": TunicLocationData("Bottom of the Well", "Bottom of the Well Back"),
    "Bottom of the Well - [Second Room] Underwater Chest": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Bottom of the Well - [Back Corridor] Right Secret": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Bottom of the Well - [Back Corridor] Left Secret": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Bottom of the Well - [Second Room] Obscured Behind Waterfall": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Bottom of the Well - [Side Room] Chest By Pots": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Bottom of the Well - [Side Room] Chest By Phrends": TunicLocationData("Bottom of the Well", "Bottom of the Well Back"),
    "Bottom of the Well - [Second Room] Page": TunicLocationData("Bottom of the Well", "Bottom of the Well Main"),
    "Dark Tomb Checkpoint - [Passage To Dark Tomb] Page Pickup": TunicLocationData("Bottom of the Well", "Dark Tomb Checkpoint"),
    ...
    "Overworld Belltower - Lantern Pickup": TunicLocationData("Overworld", "Furnace Fuse"),
    ...
    "Quarry - [Back Entrance] Bushes Holy Cross": TunicLocationData("Quarry", "Quarry Back", "holy cross"),
    "Quarry - [Back Entrance] Chest": TunicLocationData("Quarry", "Quarry Back"),
    ...
    "Quarry - [Back Entrance] Obscured Behind Wall": TunicLocationData("Quarry", "Quarry Back"),
    ...
    "Quarry - [West] Upper Area Bombable Wall": TunicLocationData("Quarry", "Quarry Back"),
    ...
    "Overworld Belltower - Chest": TunicLocationData("West Garden", "Furnace Walking Path"),
    "Overworld - [West] Near Gardens Entrance": TunicLocationData("West Garden", "Overworld to West Garden from Furnace"),
