...
enemy_location_table: dict[str, TunicLocationData] = {
    ...
    "Rooted Ziggurat Lower - Administrator 2 2nd Phase": TunicLocationData("Rooted Ziggurat Lower Front", EnemyType.administrator),
    ...
    "Rooted Ziggurat Lower - Administrator 1 2nd Phase": TunicLocationData("Rooted Ziggurat Lower Front", EnemyType.administrator),
    ...
    "Rooted Ziggurat Upper - Administrator 2nd Phase": TunicLocationData("Rooted Ziggurat Upper Front", EnemyType.administrator),
