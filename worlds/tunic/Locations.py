...
location_table: Dict[str, TunicLocationData] = {
    ...
    "East Forest - Dancing Fox Spirit Holy Cross": TunicLocationData("East Forest",
                                                                     "East Forest Dance Fox Spot", "holy cross"),
    ...
    "Forest Grave Path - Holy Cross Code by Grave": TunicLocationData("East Forest",
                                                                      "Forest Grave Path by Grave", "holy cross"),
    ...
    "Fortress Courtyard - From West Belltower": TunicLocationData("East Forest", "Fortress Exterior from East Forest"),  # todo: fix name
    ...
    "Overworld - [Southwest] From West Garden": TunicLocationData("Overworld", "Overworld Laurels"),
    ...
    "Overworld - [Southeast] Page on Pillar by Swamp": TunicLocationData("Overworld", "Overworld Laurels"),
    ...
    "Overworld - [Southwest] Fountain Page": TunicLocationData("Overworld", "Overworld Laurels"),
    "Overworld - [Northwest] Page on Pillar by Dark Tomb": TunicLocationData("Overworld", "Overworld Laurels"),
    ...
    "Overworld - [West] Moss Wall Holy Cross": TunicLocationData("Overworld Holy Cross",
                                                                 "Overworld Holy Cross", "holy cross"),
    ...
    "Secret Gathering Place - Holy Cross Chest": TunicLocationData("Overworld Holy Cross",
                                                                   "Secret Gathering Place", "holy cross"),
    "Top of the Mountain - Page At The Peak": TunicLocationData("Overworld Holy Cross",
                                                                "Top of the Mountain", "holy cross"),
    "Monastery - Monastery Chest": TunicLocationData("Quarry", "Monastery Back"),
    "Quarry - [Back Entrance] Bushes Holy Cross": TunicLocationData("Quarry", "Quarry", "holy cross"),
    "Quarry - [Back Entrance] Chest": TunicLocationData("Quarry", "Quarry"),
    ...
    "Quarry - [Back Entrance] Obscured Behind Wall": TunicLocationData("Quarry", "Quarry"),
    ...
    "Quarry - [Central] Above Ladder": TunicLocationData("Quarry", "Quarry"),
    "Quarry - [Central] Obscured Behind Staircase": TunicLocationData("Quarry", "Quarry"),
    "Quarry - [Central] Above Ladder Dash Chest": TunicLocationData("Quarry", "Quarry"),
    "Quarry - [West] Upper Area Bombable Wall": TunicLocationData("Quarry", "Quarry"),
